                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Edit Category</h4><br>
                                      
        
                                       <form action="<?=base_url('Category/update/'.$record['id'])?>" method="post" enctype="multipart/form-data" name="diviverse_form" id="diviverse_form">
											<div class="form-group">
                                                <label>Category Name</label>
                                                <input type="text" name="name" id="name" class="form-control required" value="<?=$record['name']?>" placeholder="Category Name"/>
                                            </div>
											<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    ...
                                                    <a href="<?=base_url('category')?>" class="btn btn-secondary waves-effect m-l-5">
                                                        Cancel
                                                    </a>
                                                </div>
                                            </div>
