	<!-- Home Design -->
	<section class="home-one style2 bgc-white">
		<div class="container">
			<div class="row home-content">
				<div class="col-lg-12">
					<div class="find-cand-sec">
						<div class="mockup-top"><img class="animute" src="<?=base_url('assets/')?>images/home/home2_bg.png" alt="" /></div>
					</div>
				</div>
				<div class="col-lg-8">
					<div class="home-text">
					...
					<div class="fj_post">
						<div class="details">
							...
							<div class="thumb fn-smd">
								<img class="img-fluid" src="<?=base_url('assets/')?>images/partners/1.jpg" alt="1.jpg">
							</div>
				...
				<div class="col-sm-12 col-lg-12">
					<div class="fj_post">
						<div class="details">
							...
							<div class="thumb fn-smd">
								<img class="img-fluid" src="<?=base_url('assets/')?>images/partners/2.jpg" alt="2.jpg">
							</div>
				...
				<div class="col-sm-12 col-lg-12">
					<div class="fj_post">
						<div class="details">
							<h5 class="job_chedule text-thm mt0">Full Time</h5>
							<div class="thumb fn-smd">
								<img class="img-fluid" src="<?=base_url('assets/')?>images/partners/3.jpg" alt="3.jpg">
							</div>
				...
				<div class="col-sm-12 col-lg-12">
					<div class="fj_post">
						<div class="details">
							<h5 class="job_chedule text-thm mt0">Full Time</h5>
							<div class="thumb fn-smd">
								<img class="img-fluid" src="<?=base_url('assets/')?>images/partners/4.jpg" alt="4.jpg">
							</div>
			...
			<div class="row">
				<div class="col-sm-6 col-lg-4">
					<a href="#" class="job_loc_img_box">
						<div class="thumb"><img class="img-fluid" src="<?=base_url('assets/')?>images/service/9.jpg" alt="9.jpg"></div>
						<div class="details">
							<h4>London</h4>
							<h5>152,141</h5>
						</div>
				...
				<div class="col-sm-6 col-lg-4">
					<a href="#" class="job_loc_img_box">
						<div class="thumb"><img class="img-fluid" src="<?=base_url('assets/')?>images/service/10.jpg" alt="10.jpg"></div>
						<div class="details">
							<h4>Manchester</h4>
							<h5>586,478</h5>
						</div>
				...
				<div class="col-sm-6 col-lg-4">
					<a href="#" class="job_loc_img_box">
						<div class="thumb"><img class="img-fluid" src="<?=base_url('assets/')?>images/service/11.jpg" alt="11.jpg"></div>
						<div class="details">
							<h4>Liverpool</h4>
							<h5>15,258</h5>
						</div>
				...
				<div class="col-sm-6 col-lg-4">
					<a href="#" class="job_loc_img_box">
						<div class="thumb"><img class="img-fluid" src="<?=base_url('assets/')?>images/service/12.jpg" alt="12.jpg"></div>
						<div class="details">
							<h4>Istanbul</h4>
							<h5>152,141</h5>
						</div>
				...
				<div class="col-sm-6 col-lg-4">
					<a href="#" class="job_loc_img_box">
						<div class="thumb"><img class="img-fluid" src="<?=base_url('assets/')?>images/service/13.jpg" alt="13.jpg"></div>
						<div class="details">
							<h4>New York</h4>
							<h5>586,478</h5>
						</div>
				...
				<div class="col-sm-6 col-lg-4">
					<a href="#" class="job_loc_img_box">
						<div class="thumb"><img class="img-fluid" src="<?=base_url('assets/')?>images/service/14.jpg" alt="14.jpg"></div>
						<div class="details">
							<h4>Los Angeles</h4>
							<h5>15,258</h5>
						</div>
					...
					<div class="ef_slider">
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/1.jpg" alt="1.jpg">
								</div>
								...
								<div class="details">
									<div class="job_locate">
										...
										<ul class="float-right">
											...
											<li class="list-inline-item m0"><img class="img-fluid pl5" src="<?=base_url('assets/')?>images/resource/turkey.png" alt="turkey.png"></li>
										</ul>
									</div>
									<div class="job_srate">
										<p>Job Success</p>
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/2.jpg" alt="2.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
								...
								<div class="details">
									<div class="job_locate">
										...
										<ul class="float-right">
											...
											<li class="list-inline-item m0"><img class="img-fluid pl5" src="<?=base_url('assets/')?>images/resource/usa.png" alt="usa.png"></li>
										</ul>
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/3.jpg" alt="3.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
								...
								<div class="details">
									<div class="job_locate">
										...
										<ul class="float-right">
											...
											<li class="list-inline-item m0"><img class="img-fluid pl5" src="<?=base_url('assets/')?>images/resource/brazil.png" alt="brazil.png"></li>
										</ul>
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/4.jpg" alt="4.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/5.jpg" alt="5.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/6.jpg" alt="6.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/7.jpg" alt="7.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/8.jpg" alt="8.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
						...
						<div class="item">
							<div class="ef_post">
								...
								<div class="thumb text-center">
									<img class="img-fluid" src="<?=base_url('assets/')?>images/team/9.jpg" alt="9.jpg">
								</div>
								<div class="freelancer_review">
									<div class="everage_rating">4.5</div>
									<ul class="rating_list">
