                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Add Industry</h4><br>
                                      
        
                                        <form action="<?=base_url('Industry/create')?>" method="post" enctype="multipart/form-data" name="diviverse_form" id="diviverse_form">
