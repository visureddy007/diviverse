                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Edit Font</h4><br>
                                      
        
                                       <form action="<?=base_url('Font/update/'.$record['id'])?>" method="post" enctype="multipart/form-data" name="diviverse_form" id="diviverse_form">
											<div class="form-group">
                                                <label>Font Name</label>
                                                <input type="text" name="name" id="name" class="form-control required" value="<?=$record['name']?>" placeholder="Font Name"/>
                                            </div>
											<div class="form-group">
                                                <label>Image</label>
